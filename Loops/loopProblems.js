//#1. to print both array elements
const airplanes= [['777', 'boing'],['lem', '97','gilp']];
...
// loop to sum up all values of 2 arrays
...
return sumAr;// return shd always be outside of for looP
}
console.log(arrPlusArray([5,6,7],[9,3,4]));
