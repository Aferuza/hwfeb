//#1. calculate sum of array elmentsi
let array = [53,4,5,6,7,8,9,10];
let sum = 0;
...
// #2.calculate sum of only odd array element
...
//#3. for of loop- to sum up all array elements
// for(let el of array){
//     sum = sum += el;
//     console.log(sum);
// }
// console.log(`Array at` +arr1.at);

// #4. to split a string into array
let str6 =["Hello","Winsonsin", "San Francisco"];
// var str="Hello World".split(" ");


//#6. Loop Types: 
//let arrayChar= ['a','g', 'w', 'p', 'q'];
// //1. basic for loop
...
//2. while loop
// let a = 10; // if a=10- it will be an infinite loop
// while (a >=10){
// console.log("Hey");
// }
// console.log("While loop: + no");

// 2. while loop with a num
// let j = 3;
// while (j<5){
//     console.log(j);
//     j++;// returns 3,4
...
// console.log(k+12);
// }
// while(k>2); // outputs at least 1 time 3

// 5. eg. of a break in for loop
// for(let i=0; i<5; i++){
//     if(i===3){
//         break;
//     }
//     console.log(i); // at 3 loop stops and breaks out of the loop
// }
...
//         continue;
//     }
//     console.log(i); // at 3 loop skipps 3 and moves on with 4
// }

//7. for of loop - with Arrays, Objects - access the values of array directly without index
// for(let value of arrayChar){
//     console.log(value);
// }

//7. for in loop - with Objects
const obj ={
    name:"Millo",
    username: "gmail",
    address: "CA"
...
for( let key in obj){
    console.log("Obj key is: "+ [key]);//prints only keys
    console.log("Obj value is: "+obj[key]);//prints keys+value
    // key is visible only in the scope of the for in loop
}

//8. forEach method
let arrayForEach =[56,78,94,3];
arrayForEach.forEach(function (item){
    console.log(item);
});

const socials = ["twit", "Fb", "WhtsApp"];
console.log(socials.__proto__);

//9. to print out all sitems with foraEach method
socials.forEach(function(singleItem){
    console.log(singleItem);
})

// 10. iterate over values of the object with forEach method
const person= {
    name:"Alex",
    role: "QA"
}
Object.values(person).forEach(value=>{
 ...
 //11. to print all keys of object:
Object.keys(person).forEach(value=>{
    console.log(value);
})
 
// 12. reversed sequence of array numbers with loop
const reversedSeq = n=>{
    let arr = [];
    for(let i=n; i>0; i--){
        arr.push(i);
...
//13. draw a tree made of stars (j<i)
function printStar(height){
    for(let i =1; i<=height; i++){ //rows
        row = " ";
        for(let j=1; j<i; j++){
            row+="#";
            console.log(row);
...
//14 print a square of stars- (j<size)
...
//print upside down pyramid (j=i)
function printUpsDownPyramid(size) {
    for (let i = 0; i < size; i++) {
        let row = '';
...
console.log(printUpsDownPyramid(6));
...
* Loop for strings******************************************************************************************************
* 
* Строка в JavaScript представляет собой последовательность символов, которая может содержать буквы, цифры, специальные символы и пробелы. Строки могут быть созданы с использованием одинарных (`'`) или двойных (`"`) кавычек. Например:
*/
